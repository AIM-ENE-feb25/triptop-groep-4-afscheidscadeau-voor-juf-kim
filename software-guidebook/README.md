...
* Het OCP principe wordt gebruikt om zo het implementeren en toevoegen van externe services (API's) zo makkelijk
  ...
  code. Zo is deze open voor extensie, maar gesloten voor aanpassingen.

Single Responsibility (SRP)

* Ook zorgen we er voor de interfaces zo specifiek mogelijk zijn, zodat classe die deze implementeren alleen de
